...
export const grammar = [
    ...
    },
    {
        ...
        "moji":"もう ひらがな を 覚えました。",
        "kanji":"もう ひらがな を 覚えました。",
    ...
    },
    {
        ...
        "moji":"もう チケット を 買いました。",
        "kanji":"もう チケット を 買いました。",
    ...
    },
    {
        ...
        "moji":"まだ 宿題 を して いません。",
        "kanji":"まだ 宿題 を して いません。",
    ...
    },
    {
        ...
        "moji":"まだ 北海道 へ 行って いません。",
        "kanji":"まだ 北海道 へ 行って いません。",
    ...
    },
    {
        ...
        "moji":"まだ 昼ご飯 を 食べて いません。",
        "kanji":"まだ 昼ご飯 を 食べて いません。",
    ...
    },
    {
        ...
        "moji":"まだ ひらがな を 覚えて いません。",
        "kanji":"まだ ひらがな を 覚えて いません。",
    ...
    },
    {
        ...
        "moji":"まだ チケット を 買って いません。",
        "kanji":"まだ チケット を 買って いません。",
    ...
    },
    {
        ...
        "moji":"シャワー を 浴びた あと で、 朝ご飯 を 食べます。",
        "kanji":"シャワー を 浴びた あと で、 朝ご飯 を 食べます。",
    ...
    },
    {
        ...
        "moji":"泳いだ あと で、 ビール を 飲みます。",
        "kanji":"泳いだ あと で、 ビール を 飲みます。",
    ...
    },
    {
        ...
        "moji":"帰った あと で、 手 を 洗います。",
        "kanji":"帰った あと で、 手 を 洗います。",
    ...
    },
    {
        ...
        "moji":"掃除 した あと で、 でかけます。",
        "kanji":"掃除 した あと で、 でかけます。",
    ...
    },
    {
        ...
        "moji":"食事 の あと で、 コーヒー を 飲みます。",
        "kanji":"食事 の あと で、 コーヒー を 飲みます。",
    ...
    },
    {
        ...
        "moji":"東京 で、 友達 に 会ったり、 買い物したり しました。",
        "kanji":"東京 で、 友達 に 会ったり、 買い物したり しました。",
    ...
    },
    {
        ...
        "moji":"日曜日 は 家 で 本 を 読んだり 音楽 を 聞いたり します。",
        "kanji":"日曜日 は 家 で 本 を 読んだり 音楽 を 聞いたり します。",
    ...
    },
    {
        ...
        "moji":"休み の 日、 テレビ を 見たり ビール を 飲んだり します。",
        "kanji":"休み の 日、 テレビ を 見たり ビール を 飲んだり します。",
    ...
    },
    {
        ...
        "moji":"きのう、 掃除 したり 洗濯 したり しました。",
        "kanji":"きのう、 掃除 したり 洗濯 したり しました。",
    ...
    },
    {
        ...
        "moji":"国 で 家族 と 話したり、 友達 と 遊んだり したい です。",
        "kanji":"国 で 家族 と 話したり、 友達 と 遊んだり したい です。",
    ...
    },
    {
        ...
        "moji":"歩き ながら ジュース を 飲みます。",
        "kanji":"歩き ながら ジュース を 飲みます。",
    ...
    },
    {
        ...
        "moji":"音楽 を 聞き ながら 散歩 します。",
        "kanji":"音楽 を 聞き ながら 散歩 します。",
    ...
    },
    {
        ...
        "moji":"新聞 を 読み ながら、 朝ご飯 を 食べます。",
        "kanji":"新聞 を 読み ながら、 朝ご飯 を 食べます。",
    ...
    },
    {
        ...
        "moji":"本 を 見ながら、 料理 を 作ります。",
        "kanji":"本 を 見ながら、 料理 を 作ります。",
    ...
    },
    {
        ...
        "moji":"ギター を 弾き ながら、 歌います。",
        "kanji":"ギター を 弾き ながら、 歌います。",
    ...
    },
    {
        ...
        "moji":"日本 へ 来る 前 に、 三か月 日本語 を 勉強 しました。",
        "kanji":"日本 へ 来る 前 に、 三か月 日本語 を 勉強 しました。",
    ...
    },
    {
        ...
        "moji":"国 へ 帰る 前 に、 もう 一度 友達 に 会います。",
        "kanji":"国 へ 帰る 前 に、 もう 一度 友達 に 会います。",
    ...
    },
    {
        ...
        "moji":"ごはん を 食べる 前 に、 薬 を 飲みます。",
        "kanji":"ごはん を 食べる 前 に、 薬 を 飲みます。",
    ...
    },
    {
        ...
        "moji":"勉強 の 前 に、 晩ご飯 を 食べます。",
        "kanji":"勉強 の 前 に、 晩ご飯 を 食べます。",
    ...
    },
    {
        ...
        "moji":"一か月 前 に、 日本 へ 来ました。",
        "kanji":"一か月前 に、 日本 へ 来ました。",
...
export const listening = [
    ...
    },
    {
        ...
        "moji":"かばんを部屋に持って行きます",
        "kanji":"かばんを部屋に持って行きます",
        "english":"かばんを部屋に持って行きます",
        "answerOption":[
            {
                "id":"tp7_l_1",
                "type":"listening",
...
export const reading = [
    {
        "id":"tp7_r_1",
        "type":"reading",
        "moji":"私は去年から、学校で月曜日から金曜日まで、日本語の勉強をしています。初めはとても難しかったですが、今は少し日本語が上手になりました。学校では、文法を習ったり、日本人の先生と日本語で話したりしています。　家では、漢字を書いたり、日本語のCDを聞いたりしています。日本語を勉強した後で、日本人の友だちを作って、いっしょに富士山に登ったり、すしを食べたりしたいです。",
        "questionOption":{
            "moji":"Q：日本語を勉強してから、どうしたいですか。",
            "kanji":"Q：日本語を勉強してから、どうしたいですか。"
        },
        "answerOption":[
            {
                "id":"tp7_r_5",
    ...
    },
    {
        "id":"tp7_r_2",
        "type":"reading",
        "moji":"今日、私は会社を休みました。昨日、友だちと昼ごはんを食べた後、おなかがいたくなりました。今日もまだいたいからです。昨日はとても暑かったですから、友だちと話しながら、冷たいビールをたくさん飲んだり、からい料理を食べたりしました。友だちに会う前 にも、アイスクリームを食べたり、ジュースを飲んだりしました。私は冷たくて、あまいものが好きですから。病院はまだ行っていません。朝、起きた後で薬を飲みました。",
        "questionOption":{
            "moji":"Q：どうして会社を休みましたか。",
            "kanji":"Q：どうして会社を休みましたか。"
        },
        "answerOption":[
            {
                "id":"tp7_r_2",
    ...
    },
    {
        "id":"tp7_r_3",
        "type":"reading",
        "moji":"私は月曜日から金曜日まで働いています。休みの日は、友だちの家でいっしょにDVDを見たり、部屋をそうじしたりしています。友だちの家は、少し遠いです。電車で30分かかります。1か月に1回、プールで泳いでいます。家からプールは近いです。いつもプールで泳いだ後、スーパーで買い物をして家へ帰ります。スーパーは家とプールの間にあります。会社はプールより遠いです。",
        "questionOption":{
            "moji":"Q：どこが家から一番近いですか。",
            "kanji":"Q：どこが家から一番近いですか。"
        },
        "answerOption":[
            {
                "id":"tp7_r_5",
