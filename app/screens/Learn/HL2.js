        ...
        <ScrollView style = { [study.StudyContainer] }>
            ...
            <View style={study.tableContainer}>
              <View style={[styles.row]}>
                <View style={ [styles.col2Tbl,study.tableRow, study.tableBorder, study.tableHeader] }>
                  <Text style={study.textCenter}>母音 | 子音</Text>
                </View>
                <View style={ [styles.col2Tbl, study.tableBorder, study.tableHeader] }>
                  <Text style={study.textCenter}>a</Text>
                </View>
                <View style={ [styles.col2Tbl, study.tableBorder, study.tableHeader] }>
                  <Text style={study.textCenter}>i</Text>
                </View>
                <View style={ [styles.col2Tbl, study.tableBorder, study.tableHeader] }>
                  <Text style={study.textCenter}>u</Text>
                </View>
                <View style={ [styles.col2Tbl, study.tableBorder, study.tableHeader] }>
                  <Text style={study.textCenter}>e</Text>
                </View>
                <View style={ [styles.col2Tbl, study.tableBorder, study.tableHeader] }>
                  <Text style={study.textCenter}>o</Text>
                </View>
    
              </View>
              <View style={styles.row}>
                <View style={ [styles.col2Tbl, study.tableBorder] }>
                  <Text></Text>
                </View>
                <View style={ [styles.col2Tbl, study.tableBorder] }>
                  <Text style={study.textCenter}>あ {"\n"} a</Text>
                </View>
                <View style={ [styles.col2Tbl, study.tableBorder] }>
                  <Text style={study.textCenter}>い {"\n"} i</Text>
                </View>
                <View style={ [styles.col2Tbl, study.tableBorder] }>
                  <Text style={study.textCenter}>う {"\n"} u</Text>
                </View>
                <View style={ [styles.col2Tbl, study.tableBorder] }>
                  <Text style={study.textCenter}>え {"\n"} e</Text>
                </View>
                <View style={ [styles.col2Tbl, study.tableBorder] }>
                  <Text style={study.textCenter}>お {"\n"} o</Text>
                </View>
              </View>
            </View>
            <Text>
